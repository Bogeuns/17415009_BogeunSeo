...
if 'Points_1' not in df.columns or 'Pressure_Coefficient' not in df.columns:
    print("Error: 'Points_1' or 'Pressure_Coefficient' columns are missing in the CSV file.")
    sys.exit()
...
df['P_minus_Pat'] = df['Pressure_Coefficient'] - P_at
...
sheet1.write('B1', 'Pressure_Coefficient')
...
for i, row in df.iterrows():
    ...
    sheet1.write(i+1, 1, row['Pressure_Coefficient'])
...
sheet2.write(0, 1, 'Pressure_Coefficient')
for i, row in df.iterrows():
    sheet2.write(i+1, 0, row['Points_1'])
    sheet2.write(i+1, 1, row['Pressure_Coefficient'])
